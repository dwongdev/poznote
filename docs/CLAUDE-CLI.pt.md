...
A configuração será salva em um destes locais:
- **Nível de projeto:** `/your/project/.claude.json` (quando executado dentro de um projeto)
- **Nível de usuário:** `~/.claude.json` (configuração global)
